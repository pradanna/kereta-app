...
class AddAuthorTechSpecSeEquipment extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('ts_special_equipment', function (Blueprint $table) {
            ...
            $table->dropForeign('ts_special_equipment_created_by_foreign');
            $table->dropForeign('ts_special_equipment_updated_by_foreign');
