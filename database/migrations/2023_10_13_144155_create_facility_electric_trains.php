...
class CreateFacilityElectricTrains extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('facility_electric_trains', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('facility_electric_trains');
    }
}
