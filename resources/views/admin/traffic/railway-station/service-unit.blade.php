...
@section('content')
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            <h1 class="h1">STASIUN KERETA API</h1>
            <p class="mb-0">Manajemen Data Stasiun Kereta Api</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('traffic') }}">Lalu Lintas</a></li>
                <li class="breadcrumb-item active" aria-current="page">Stasiun Kereta Api</li>
            </ol>
        </nav>
    </div>
    <section class="pt-3">
