    ...
    @if (\Illuminate\Support\Facades\Session::has('success'))
        <script>
            Swal.fire({
                ...
                window.location.href = '{{ route('wagon-type.sub-type', ['id' => $wagon->id]) }}';
            })
        </script>
    @endif
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('wagon-type.sub-type', ['id' => $wagon->id]) }}">{{ $wagon->name }}</a></li>
                    ...
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control" id="code" name="code"
                                placeholder="Kode Sub Tipe Jenis Gerbong" value="{{ $data->code }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                placeholder="Nama Sub Tipe Jenis Gerbong" value="{{ $data->name }}">
                        </div>
                    </div>
                </div>
                <hr>
