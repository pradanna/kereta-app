                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            <div class="w-100">
                                ...
                                <input type="text" class="form-control" id="corridor" name="corridor" disabled>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="w-100">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            <div class="w-100">
                                ...
                                <input type="text" class="form-control" id="span" name="span" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            <div class="w-100">
                                ...
                                <input type="text" class="form-control" id="bridge_type" name="bridge_type" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
