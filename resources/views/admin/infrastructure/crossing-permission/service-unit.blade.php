...
@section('content')
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            <h1 class="h1">PERMOHONAN IZIN MELINTAS REL</h1>
            <p class="mb-0">Manajemen Data Permohonan Izin Melintas Rel</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('infrastructure') }}">Prasarana</a></li>
                <li class="breadcrumb-item active" aria-current="page">Permohonan Izin Melintas Rel</li>
            </ol>
        </nav>
    </div>
    <section class="pt-3">
