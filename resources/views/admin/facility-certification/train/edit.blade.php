...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            ...
            <p class="mb-0">Manajemen Edit Data Sertifikasi Sarana Kereta</p>
        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group w-100">
                            ...
                            <select class="select2 form-control" name="engine_type" id="engine_type" style="width: 100%;">
                                <option value="train" {{ $data->engine_type === 'train' ? 'selected' : '' }}>Kereta Api
                                </option>
                                <option value="electric-train"
                                    {{ $data->engine_type === 'electric-train' ? 'selected' : '' }}>KRL</option>
                                <option value="diesel-train" {{ $data->engine_type === 'diesel-train' ? 'selected' : '' }}>
                                    KRD</option>
                            </select>
                        </div>
                    </div>
