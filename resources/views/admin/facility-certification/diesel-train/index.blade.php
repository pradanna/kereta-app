...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sertifikasi Sarana Kereta Diesel</li>
            </ol>
        </nav>
    </div>
    <div class="panel w-100 shadow-sm">
        <div class="title">
            ...
            <a class="btn-utama sml rnd " href="{{ route('facility-certification-train-diesel.create') }}">Tambah
