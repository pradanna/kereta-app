...
@section('content')
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            <h1 class="h1">SERTIFIKASI SARANA KERETA REL LISTRIK (KRL)</h1>
            <p class="mb-0">Manajemen Data Sertifikasi Sarana Kereta Rel Listrik (KRL)</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Sertifikasi Sarana Kereta Rel Listrik</li>
            </ol>
        </nav>
    </div>
    <div class="panel w-100 shadow-sm">
        <div class="title">
            <p>Sertifikasi Sarana Kereta Listrik</p>
            <div class="d-flex align-item-center">
                <a class="btn-utama sml rnd me-2" href="{{ route('facility-certification-train-electric.create') }}">Tambah
                    <i class="material-symbols-outlined menu-icon ms-2 text-white">add_circle</i>
                </a>
                <a class="btn-utama sml rnd " href="{{ route('facility-certification-train-electric.excel') }}" target="_blank">Excel
                    <i class="material-symbols-outlined menu-icon ms-2 text-white">add_circle</i>
                </a>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        let table;
        let path = '{{ route('facility-certification-train-electric') }}';
