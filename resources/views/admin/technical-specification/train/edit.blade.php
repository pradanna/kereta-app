                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <div class="form-group w-100">
                            ...
                            <select class="select2 form-control" name="facility_train" id="facility_train"
                                style="width: 100%;">
                                @foreach ($facility_trains as $facility_train)
                                    <option value="{{ $facility_train->id }}">{{ $facility_train->facility_number }}
                                        ({{ $facility_train->train_type->name }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
