...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            ...
            <p class="mb-0">Manajemen Data Dokumen Spesifikasi Teknis Sarana Gerbong</p>
        </div>
    ...
    <div class="panel">
        <div class="title">
            <p>Dokumen Spesifikasi Teknis Sarana Gerbong {{ $data->wagon_sub_type->code }}</p>
        </div>
        <div class="isi">
...
@section('js')
    ...
    <script>
        ...
        function destroy(id) {
            let url = '{{ route('technical-specification.wagon') }}' + '/' + id + '/delete-document';
