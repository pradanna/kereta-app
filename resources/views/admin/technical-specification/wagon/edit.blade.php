                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <div class="form-group w-100">
                            ...
                            <select class="select2 form-control" name="facility_wagon" id="facility_wagon"
                                style="width: 100%;">
                                @foreach ($facility_wagons as $facility_wagon)
                                    <option value="{{ $facility_wagon->id }}">{{ $facility_wagon->facility_number }}
                                        ({{ $facility_wagon->wagon_sub_type->name }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
