            ...
            <ul class="nav flex-column " style=" " id="nav_accordion">
                ...
                <li class="nav-item">
                    <a class="nav-link menu {{ request()->is('sarana-dan-keselamatan*') ? 'active' : '' }}"
                        ...
                        <p class="menu-text">SARANA DAN KESELAMATAN</p>
                    </a>
                </li>
                <li class="nav-item">
                ...
                {{--                            home --}}
                {{--                        </span> --}}
                {{--                        <p class="menu-text">Sarana Dan Keselamatan Perkeretaapian</p> --}}
                {{--                    </a> --}}
                {{--                </li> --}}
                ...
                @php
                    $certification = [
                        ...
                        'sertifikasi-sarana-kereta-diesel',
                ...
                @php
                    $summary = [
                        'rekapitulasi-sarana',
                        'rekapitulasi-jalur-perlintasan-langsung',
                        'rekapitulasi-daerah-rawan-bencana',
                    ];
                    $openSummary = false;
