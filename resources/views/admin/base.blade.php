        ...
        <ul class="nav flex-column " style=" !important" id="nav_accordion">
            ...
            <li class="nav-item">
                <a class="nav-link menu">
                    ...
                    <p class="menu-text {{ (in_array(request()->path(), $certification) || $openCertification) ? 'fw-bold' : '' }}">
            ...
            <li class="nav-item">
                <a class="nav-link menu"
                   href="#">
                    ...
                    <p class="menu-text {{ (in_array(request()->path(), $technicalSpec) || $openTechnicalSpec) ? 'fw-bold' : '' }}">
            ...
            <li class="nav-item">
                <a class="nav-link menu"
                   href="#">
                    ...
                    <p class="menu-text {{ (in_array(request()->path(), $summary) || $openSummary) ? 'fw-bold' : '' }}">
                        Rekapitulasi</p>
                </a>
