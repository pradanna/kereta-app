...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            ...
            <p class="mb-0">Manajemen Tambah Data Master Jenis Peralatan Khusus</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('master-data') }}">Master Data</a></li>
                <li class="breadcrumb-item"><a href="{{ route('special-equipment-type') }}">Jenis Peralatan Khusus</a></li>
    ...
    <div class="panel ">
        <div class="title">
            <p>Form Data Jenis Peralatan Khusus</p>
        </div>
        <div class="isi">
