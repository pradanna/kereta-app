...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            ...
            <p class="mb-0">Manajemen Tambah Data Master Sub Jenis Gerbong</p>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="{{ route('master-data') }}">Master Data</a></li>
                <li class="breadcrumb-item"><a href="{{ route('wagon-sub-type') }}">Sub Jenis Gerbong</a></li>
                        ...
                        <div class="form-group w-100">
                            ...
                            <select class="select2 form-control" name="wagon_type" id="wagon_type" style="width: 100%;">
                                @foreach ($wagon_types as $wagon_type)
                                    <option value="{{ $wagon_type->id }}">{{ $wagon_type->name }} ({{ $wagon_type->code }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control" id="code" name="code"
                                   placeholder="Kode Sub Jenis Gerbong">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                   placeholder="Nama Sub Jenis Gerbong">
                        </div>
                    </div>
                </div>
                <hr>
