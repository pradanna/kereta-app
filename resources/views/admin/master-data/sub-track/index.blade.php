...
@section('content')
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            ...
            <p class="mb-0">Manajemen Data Petak {{ $service_unit->name }}</p>
        </div>
    ...
    <div class="panel">
        <div class="title">
            ...
            <div class="d-flex align-item-center">
                <a class="btn-utama sml rnd me-2" href="{{ route('sub-track.service-unit.create', ['service_unit_id' => $service_unit->id]) }}">Tambah
