                                        ...
                                        <select class="select2 form-control" name="track" id="track"
                                            ...
                                            @foreach ($tracks as $track)
                                                <option value="{{ $track->id }}"
                                                    {{ $data->track_id === $track->id ? 'selected' : '' }}>
                                                    {{ $track->code }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('track'))
                                ...
                                <div class="col-6">
                                    <div class="w-100">
                                        ...
                                        <input type="text" step="any" class="form-control" id="elevation"
                                            name="elevation" placeholder="0" value="{{ $data->elevation }}">
                                ...
                                <div class="col-12">
                                    <div class="form-group w-100">
                                        ...
                                        <select class="select2 form-control" name="is_closed" id="is_closed"
                                            style="width: 100%;">
                                            <option value="0" {{ 0 == $data->is_closed ? 'selected' : '' }}>Aktif
                                            </option>
                                            <option value="1" {{ 1 == $data->is_closed ? 'selected' : '' }}>Tidak
                                                Aktif</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="crossing_exists"
                                                ...
                                                {{ 1 === $data->sign_equipment->crossing_exists ? 'checked' : '' }}>
                                            <label class="form-check-label" for="crossing_exists_yes">ADA</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="crossing_exists"
                                                id="crossing_exists_no" value="0"
                                                {{ 0 === $data->sign_equipment->crossing_exists ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="look_around"
                                                ...
                                                {{ 1 === $data->sign_equipment->look_around ? 'checked' : '' }}>
                                            <label class="form-check-label" for="look_around_yes">ADA</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="look_around"
                                                id="look_around_no" value="0"
                                                {{ 0 === $data->sign_equipment->look_around ? 'checked' : '' }}>
