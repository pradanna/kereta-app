    ...
    @if (\Illuminate\Support\Facades\Session::has('success'))
        <script>
            Swal.fire({
                ...
                window.location.href = '{{ route('means.illegal-building.service-unit', ['service_unit_id' => $service_unit->id]) }}';
            })
        </script>
    @endif
    <div class="d-flex justify-content-between align-items-end mb-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('means.illegal-building') }}">Daerah Bangunan Liar {{ $service_unit->name }}</a></li>
        ...
        <div class="panel ">
            ...
            <div class="isi">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        <div class="w-100">
                            <label for="surface_area" class="form-label">Luas Tanah (m2) <span class="text-danger ms-1">*</span></label>
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="w-100">
                            <label for="building_area" class="form-label">Luas Bangunan (m2) <span class="text-danger ms-1">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="w-100">
                            <label for="distance_from_rail" class="form-label">Jarak Dari AS Rel <span class="text-danger ms-1">*</span></label>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="w-100">
                            <label for="illegal_building" class="form-label">Jumlah Bangunan Liar (+/-) <span class="text-danger ms-1">*</span></label>
