...
@section('content')
        ...
        <script>
            Swal.fire({
                ...
                window.location.href =
                    '{{ route('means.material-tool.main', ['service_unit_id' => $service_unit->id]) }}';
            })
        </script>
    @endif
    ...
    <form method="post" id="form-data">
        ...
        <div class="panel ">
            <div class="title">
                <p>Edit Data Alat Material Untuk Siaga (AMUS)</p>
            </div>
            <div class="isi">
                <div class="row mb-3">
                    <div class="col-6">
                            ...
                            <select class="select2 form-control" name="resort" id="resort" style="width: 100%;">
                                @foreach ($resorts as $resort)
                                    <option value="{{ $resort->id }}"
                                        {{ $resort->id === $data->resort_id ? 'selected' : '' }}>{{ $resort->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="w-100">
                            <label for="type" class="form-label">Jenis Amus <span
                                    class="text-danger ms-1">*</span></label>
