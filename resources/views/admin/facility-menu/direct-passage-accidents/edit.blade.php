                        ...
                        <div class="form-group w-100">
                            ...
                            <select class="select2 form-control" name="direct_passage" id="direct_passage"
                                ...
                                @foreach ($direct_passages as $direct_passage)
                                    <option value="{{ $direct_passage->id }}" {{ ($direct_passage->id === $data->direct_passage_id) ? 'selected' : '' }}>{{ $direct_passage->name }} ({{ $direct_passage->stakes }}) ({{ $direct_passage->sub_track->code }}) ({{ $direct_passage->sub_track->track->code }}) ({{ $direct_passage->sub_track->track->area->name }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="text" step="any" class="form-control" id="train_name"
                                   name="train_name" value="{{ $data->train_name }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <select class="select2 form-control" name="accident_type" id="accident_type"
                                    style="width: 100%;">
                                <option value="KA Tertemper Kendaraan" {{ ($data->accident_type === 'KA Tertemper Kendaraan') ? 'selected' : '' }}>KA Tertemper Kendaraan</option>
                                <option value="KA Tertemper Orang" {{ ($data->accident_type === 'KA Tertemper Orang') ? 'selected' : '' }}>KA Tertemper Orang</option>
                                <option value="KA Dengan KA" {{ ($data->accident_type === 'KA Dengan KA') ? 'selected' : '' }}>KA Dengan KA</option>
                                <option value="KA Terguling" {{ ($data->accident_type === 'KA Terguling') ? 'selected' : '' }}>KA Terguling</option>
                                <option value="Bencana Lain" {{ ($data->accident_type === 'Bencana Lain') ? 'selected' : '' }}>Bencana Lain</option>
                            </select>
                        </div>
                    </div>
                </div>
