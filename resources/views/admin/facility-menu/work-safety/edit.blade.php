                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control" id="work_unit" name="work_unit" value="{{ $data->work_unit }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="w-100">
                            <label for="supervision_consultant" class="form-label">Konsultan Supervisi</label>
                            <input type="text" class="form-control" id="supervision_consultant" name="supervision_consultant" value="{{ $data->supervision_consultant }}">
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control" id="contractor" name="contractor" value="{{ $data->contractor }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="w-100">
                            <label for="work_package" class="form-label">Paket Pekerjaan</label>
                            <input type="text" class="form-control" id="work_package" name="work_package" value="{{ $data->work_package }}">
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="w-100">
                            ...
                            <input type="number" class="form-control" id="period" name="period" value="{{ $data->period }}">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="w-100">
                            <label for="performance" class="form-label">Kinerja</label>
                            <input type="text" class="form-control" id="performance" name="performance" value="{{ $data->performance }}">
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
