...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            <h1 class="h1">DEPO DAN BALAI YASA {{ $service_unit->name }}</h1>
            <p class="mb-0">Manajemen Data Depo Dan Balai Yasa {{ $service_unit->name }}</p>
        </div>
        ...
        <div class="isi">
            <form method="post" id="form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-6">
                        <div class="form-group w-100">
                            <label for="storehouse_type" class="form-label">Tipe Depo<span
                                    class="text-danger ms-1">*</span></label>
