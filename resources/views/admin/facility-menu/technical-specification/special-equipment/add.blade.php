        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('means.technical-specification.special-equipment') }}">Peralatan Khusus</a></li>
        ...
        <div class="isi">
            <form method="post" id="form-data">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="form-group w-100">
                            <label for="special_equipment_type" class="form-label">Jenis Peralatan Khusus <span
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="form-group w-100">
                            <label for="usability" class="form-label">Jenis / Fungsi Peralatan Khusus <span
                                    class="text-danger ms-1">*</span></label>
                            <input type="text" class="form-control" id="usability" name="usability"
                                placeholder="Jenis / Fungsi Peralatan Khusus">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="form-group w-100">
                            <label for="long" class="form-label">Panjang (mm) <span
                                    class="text-danger ms-1">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="form-group w-100">
                            <label for="height" class="form-label">Tinggi (mm) <span
                                    class="text-danger ms-1">*</span></label>
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <div class="form-group w-100">
                            <label for="width" class="form-label">Lebar (mm) <span
                                    class="text-danger ms-1">*</span></label>
