...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-end mb-4">
        <div class="page-title-container">
            ...
            <p class="mb-0">Manajemen Data Gambar Spesifikasi Teknis Sarana Kereta</p>
        </div>
    ...
    <div class="panel">
        <div class="title">
            <p>Gambar Spesifikasi Teknis Sarana Kereta {{ $data->train_type->code }}</p>
        </div>
        <div class="isi">
...
@section('js')
    ...
    <script>
        ...
        function destroy(id) {
            let url = '{{ route('means.technical-specification.train') }}' + '/' + id + '/delete-image';
