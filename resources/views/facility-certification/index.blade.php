        ...
        function generateTableFacilityCertification() {
            table = $('#table-data').DataTable({
                    ...
                    columnDefs: [
                        ...
                        {width: 120, targets: 2, className: 'text-center'},
                        {width: 150, targets: 3, className: 'text-center'},
                        {width: 180, targets: 4, className: 'text-center'},
                        {width: 120, targets: 5, className: 'text-center'},
                        {width: 100, targets: 6, className: 'text-center'},
                        {width: 100, targets: 7, className: 'text-center'},
                        {width: 250, targets: 8, className: 'text-center'},
                        {width: 120, targets: 9, className: 'text-center'},
                        {width: 120, targets: 10, className: 'text-center'},
