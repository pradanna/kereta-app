...
function windowContentStorehouseMarker(data) {
  return (
    ...
    data["id"] +
    '" style="text-decoration: none;">' +
    '<span style="color: #777777; font-size: 12px;">KRD (' +
    data["count_diesel_train"] +
    ")</span>" +
    "</div>" +
    "</div>" +
    '<div class="w-100 d-flex align-items-center justify-content-center mb-1">' +
    ...
    data["id"] +
    '" style="text-decoration: none;">' +
    '<span style="color: #777777; font-size: 12px;">KRL (' +
    data["count_electric_train"] +
    ")</span>" +
    "</div>" +
    "</div>" +
    '<div class="w-100 d-flex align-items-center justify-content-center mb-1">' +
    ...
    data["id"] +
    '" style="text-decoration: none;">' +
    '<span style="color: #777777; font-size: 12px;">Peralatan Khusus (' +
    data["count_special_equipment"] +
    ")</span>" +
    "</div>" +
    "</div>" +
    "</div>"
