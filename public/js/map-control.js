...
function windowContentDirectPassageMarker(data) {
  return (
    ...
    ")</p>" +
    '<div class="w-100 d-flex align-items-center justify-content-center mb-1">' +
    '<a href="#" onclick="goToDirectPassageGuardPage(this)" class="d-flex align-items-center btn-facility" data-id="' +
    data["id"] +
    '" style="text-decoration: none;">' +
...
function windowContentStorehouseMarker(data) {
  return (
    ...
    ")</p>" +
    '<div class="w-100 d-flex align-items-center justify-content-center mb-1">' +
    '<a href="#" onclick="goToFacilityLocomotivePage(this)" class="d-flex align-items-center btn-facility" data-id="' +
    data["id"] +
    '" style="text-decoration: none;">' +
    ...
    "</div>" +
    '<div class="w-100 d-flex align-items-center justify-content-center mb-1">' +
    '<a href="#" onclick="goToFacilityTrainPage(this)" class="d-flex align-items-center btn-facility" data-id="' +
    data["id"] +
    '" style="text-decoration: none;">' +
    ...
    "</div>" +
    '<div class="w-100 d-flex align-items-center justify-content-center mb-1">' +
    '<a href="#" onclick="goToFacilityWagonPage(this)" class="d-flex align-items-center btn-facility" data-id="' +
    data["id"] +
    '" style="text-decoration: none;">' +
